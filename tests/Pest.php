...
| specific PHPUnit test case class. By default, that class is "PHPUnit\
| Framework\TestCase". Of course, you may need to change it using the
| "uses()" function to bind a different classes or traits.
|
*/
